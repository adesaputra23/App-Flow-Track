...
@section('content')
    <div class="w-full">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('pesanan.tambah') }}" class="px-4 py-2 rounded text-white transition"
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($list_data as $i => $data)
                        <tr>
                            ...
                            <td class="px-6 py-4 border border-gray-300">{{ $data->instansi }}</td>
                            <td class="px-6 py-4 border border-gray-300">{{ $data->no_hp }}</td>
                            <td class="px-6 py-4 border border-gray-300 text-center">{{ $data->jam }}</td>
